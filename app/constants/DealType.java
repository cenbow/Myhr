...
public class DealType {
	...
	public static final int RETURN_GOLD_AMOUNT = 120;//回收体验金(t_bill_invests id)
	public static final int DEBT_RETURN_GOLD_AMOUNT = 121;//债权转让回收体验金(t_invest_transfers id)
...
//	public static final int TRANSFER_MER_TO_USER = 13; //商户转账给用户
	...
	public static final int REGISTER_EXPERIENCE_GOLD = 323; //注册获得体验金
	
	public static final int INVEST_GOLD_AMOUNT = 324;//投资使用体验金
