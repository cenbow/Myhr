...
/**
 * 
 * @author liubaoding 20160525 短信接口是乾璟通
 * 
 */
public class QJTSMSUtil
{
    ...
    public static class Client
    {
        ...
        private static String serviceURL = "http://sdk2.entinfo.cn:8061/webservice.asmx";
        private static String sn = "DXX-MDQ-010-00115";
        private static String password = "#e86-e#6";
        private static String pwd = QJTSMSUtil.Client.getMD5(sn + password);// 密码

        /*
         * 方法名称：getMD5 功 能：字符串MD5加密 参 数：待转换字符串 返 回 值：加密之后字符串
         */
        public static String getMD5(String sourceStr) // throws
         ...
         */
        public static String mdgxsend(String mobile, String content, String ext, String stime, String rrid,
                String msgfmt)
        {
            String result = "";
         ...
         * 值：唯一标识，如果不填写rrid将返回系统生成的
         */
        public static String mdsmssend(String mobile, String content, String ext, String stime, String rrid,
                String msgfmt)
        {
            String result = "";
        ...
        public static void main(String[] args) throws UnsupportedEncodingException
        {
            ...
            // String sn = "DXX-MDQ-010-00115";
            // String pwd = "#e86-e#6";
            // Client client = new Client(sn, pwd);

            // 短信发送
            // String content = java.net.URLEncoder.encode("确认是否是本人操作[拓米金融]",
            // "utf-8");
            // String result_mt = Client.mdsmssend("18251894658", content, "",
            // "", "", "");
            //
