...
public class KLZHttpUtil
{
    ...
    private static String getUrl(Map map)
    {
        ...
        for (Iterator i = keys.iterator(); i.hasNext();)
        {
            ...
            /*
             * if (map.containsKey(key)) { Object val = map.get(key); String str
             * = val != null ? val.toString() : ""; try { str =
             * URLEncoder.encode(str, "GBK"); } catch
