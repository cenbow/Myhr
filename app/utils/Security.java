...
public class Security
{
    ...
    {
        String des = com.shove.security.Encrypt.encrypt3DES(
                id + "," + action + "," + DateUtil.dateToString(new Date()), Constants.ENCRYPTION_KEY);
    ...
    public static long decryCookie(String encryCookie, String action, ErrorInfo error)
    {
        ...
        /*
         * String userAgent =
         * Request.current().headers.get("user-agent").toString();
         * 
         * if(!userAgent.equals(cookie[3])){ error.code = -5; error.msg =
         * "cookie信息有误";
         * 
         * return error.code; }
         */
